...
<div class="wrapper d-flex flex-column min-vh-100 bg-light">
    <header class="header header-sticky mb-4">
        <div class="container-fluid">
            <button class="header-toggler px-md-4 me-md-3" type="button" data-coreui-toggle="sidebar" data-coreui-target="#sidebar" aria-controls="sidebar" aria-label="Toggle sidebar">
                <i class="cil-menu"></i>
            </button>
